...
CORRUPTIONS_DIR_NAMES: Dict[BenchmarkDataset, str] = {
    ...
    BenchmarkDataset.imagenet3d: "ImageNet-3D"
}
...
def load_imagenet3dc(
    ...
    data_folder_path = Path(data_dir) / CORRUPTIONS_DIR_NAMES[BenchmarkDataset.imagenet3d] / corruptions[0] / str(severity)
    imagenet = CustomImageFolder(data_folder_path, transforms_test)
